...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   let mayorParcial = arrayOfNums[0]
   for (let i = 0; i < arrayOfNums.length; i++) {
      const element = arrayOfNums[i];
      if (element > mayorParcial){
         mayorParcial = element;
      }
   }
   return mayorParcial;
}
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   numEnString = num.toString( [10] )
   const numEnArray = numEnString.split("");
   return (numEnArray[0] == "9")
}
...
function todosIguales(array) {
   ...
   for (let i = 0; i < array.length; i++) {
      ...
      return array.every( num => num == element)
   }
...
function mesesDelAño(array) {
   ...
   if (arrayNuevo.includes("Enero","Marzo","Noviembre")){
      return arrayNuevo;
   }else{
...
/* if (array.includes("Enero","Marzo","Noviembre")){
      const arrayNuevo = ["Enero","Marzo","Noviembre"];
      return arrayNuevo;
   }else{
      return "No se encontraron los meses pedidos";
   }*/
