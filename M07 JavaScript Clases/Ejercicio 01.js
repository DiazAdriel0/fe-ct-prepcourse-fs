...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function() {
      const stringEnArray = this.split("");
      const arrayInvertido = [];
      // En vez de este for podía usar un for normal para recorrer el array de principio a fin y en lugar de usar el metodo push usaba el metodo unshift
      for (let i = (stringEnArray.length - 1); i > -1; i--) {
         const element = stringEnArray[i];
